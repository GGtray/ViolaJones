...
classifiers1 = adaboost(faces_ii_training, non_faces_ii_training, 1)
...
# correct_faces = 0
# correct_non_faces = 0
# correct_faces = sum(utils.ensemble_vote_all(faces_ii_testing, classifiers1))
# correct_non_faces = len(non_faces_testing) - sum(utils.ensemble_vote_all(non_faces_ii_testing, classifiers1))
#
